...
Adafruit_NeoPixel_Universal::Adafruit_NeoPixel_Universal(uint16_t n, uint8_t p, neoPixelType t) :
...
void Adafruit_NeoPixel_Universal::begin(void) {
  if(pin >= 0) {
    pinMode(pin, OUTPUT);
...
void Adafruit_NeoPixel_Universal::updateLength(uint16_t n) {
...
void Adafruit_NeoPixel_Universal::updateType(neoPixelType t) {
...
void Adafruit_NeoPixel_Universal::show(void) {
...
#if defined(PORTD)
 #if defined(PORTB) || defined(PORTC) || defined(PORTF) || defined(PORTA)
    if(port == &PORTD) {
...
#if defined(PORTB)
 #if defined(PORTD) || defined(PORTC) || defined(PORTF)|| defined(PORTA)
    if(port == &PORTB) {
...
#if defined(PORTC)
 #if defined(PORTD) || defined(PORTB) || defined(PORTF)|| defined(PORTA)
    if(port == &PORTC) {
...
#if defined(PORTF)
 #if defined(PORTD) || defined(PORTB) || defined(PORTC)|| defined(PORTA)
    if(port == &PORTF) {
...
#if defined(PORTA)
 #if defined(PORTD) || defined(PORTB) || defined(PORTC)|| defined(PORTF)
    if(port == &PORTA) {
 #endif // defined(PORTD/B/C)
...
// 12 MHz(ish) AVR --------------------------------------------------------
 ...
 #endif
 #if defined(PORTC) || defined(PORTF) || defined(PORTA)
    else
 #endif // defined(PORTC/F)
#endif // defined(PORTB)
...
void Adafruit_NeoPixel_Universal::setPin(uint8_t p) {
...
void Adafruit_NeoPixel_Universal::setPixelColor(
...
void Adafruit_NeoPixel_Universal::setPixelColor(uint16_t n, uint32_t c) {
  if(n < numLEDs) {
    uint8_t *p,
      r = (uint8_t)(c >> 16),
      g = (uint8_t)(c >>  8),
...
uint32_t Adafruit_NeoPixel_Universal::Color(uint8_t r, uint8_t g, uint8_t b) {
  return ((uint32_t)r << 16) | ((uint32_t)g <<  8) | b;
}

// Convert separate R,G,B,W into packed 32-bit WRGB color.
// Packed format is always WRGB, regardless of LED strand color order.
uint32_t Adafruit_NeoPixel_Universal::Color(uint8_t r, uint8_t g, uint8_t b, uint8_t w) {
  return ((uint32_t)w << 24) | ((uint32_t)r << 16) | ((uint32_t)g <<  8) | b;
}

// Query color from previously-set pixel (returns packed 32-bit RGB value)
uint32_t Adafruit_NeoPixel_Universal::getPixelColor(uint16_t n) const {
...
uint8_t *Adafruit_NeoPixel_Universal::getPixels(void) const {
  return pixels;
}

uint16_t Adafruit_NeoPixel_Universal::numPixels(void) const {
  return numLEDs;
}
...
void Adafruit_NeoPixel_Universal::setBrightness(uint8_t b) {
...
uint8_t Adafruit_NeoPixel_Universal::getBrightness(void) const {
  return brightness - 1;
}

void Adafruit_NeoPixel_Universal::clear() {
  memset(pixels, 0, numBytes);
}
